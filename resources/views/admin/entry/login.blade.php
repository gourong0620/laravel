...
<div class="container logo">
    <div style="background: url('https://www.baidu.com/img/bd_logo1.png') no-repeat; background-size: contain;height: 60px;"></div>
</div>
<div class="container well">
    <div class="row ">
        ...
        <div class="col-md-6">
            <div style="background: url('https://www.baidu.com/img/bd_logo1.png');background-size:100% ;height:230px;"></div>
        </div>
    </div>
    <div class="copyright">
